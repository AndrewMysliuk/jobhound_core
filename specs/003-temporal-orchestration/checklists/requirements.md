...
- [x] Aligned with [`product-concept-draft.md`](../../000-epic-overview/product-concept-draft.md): foundation only; slot/idempotency expectations forwarded to `006`/`007`/`008`/`009`
...
- [x] Out of scope boundaries clear (`006`, `008`, `009`, `010`, prod workers)
