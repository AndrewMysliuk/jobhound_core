...
**Purpose**: Single **demo** workflow and **one** activity to validate Temporal wiring, registration, and Web UI visibility. **Not** product logic; replace or extend in later specs (`006`, `008`, `009`, `011`). Product runs will carry **`slot_id`** (and **`user_id`** when applicable) per [`product-concept-draft.md`](../../000-epic-overview/product-concept-draft.md)—**not** part of this v0 I/O contract.
