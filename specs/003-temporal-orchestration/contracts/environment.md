...
The **reference v0** workflow does **not** require `JOBHOUND_DATABASE_URL`. If a future worker binary loads DB and Temporal, both contracts apply: see `specs/002-postgres-gorm-migrations/contracts/environment.md`.
