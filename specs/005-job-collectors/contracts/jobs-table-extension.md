...
**Supplements** `specs/002-postgres-gorm-migrations/contracts/jobs-schema.md` when **`domain.Job`** gains salary/tags/position (see **`domain-mapping-mvp.md`**). Apply via a **new numbered migration** in `migrations/` at implementation time (not part of this markdown-only spec deliverable).
