...
- Real collectors beyond what later epics specify, production Telegram, full GORM/Postgres schema ( **`002`** ), Temporal workflows ( **`003`** ), public HTTP API (**`011`**).
...
- **Slot CRUD and reset semantics** — narrative in product draft §5; technical contracts in **`009` / `011`** and storage epics.
