...
- **Product draft**: `spec.md` links [`product-concept-draft.md`](../../000-epic-overview/product-concept-draft.md) and states how **`jobs`** relates to **slot-scoped** data (`007` / `006` / `009`).
